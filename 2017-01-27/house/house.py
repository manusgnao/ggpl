...
woodTexture = "house/texture/wood.png"
wallTexture = "house/texture/wall.jpg"
stoneTexture = "house/texture/stone.jpg"
...
def readSvg(l,level,path):
  file = open("house/elements/"+path+"/lines/level-"+str(l)+".lines","r")
  data = file.read()
  n = countFileDirectory("house/elements/"+path+"/lines/")
  file.close()
  d = data.splitlines()
  level = level + [d]
  if l!=n-1:
